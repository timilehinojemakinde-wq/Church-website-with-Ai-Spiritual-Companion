        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-none">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm mb-6">
              <Sparkles className="w-3.5 h-3.5 text-rccg-gold" />
              <span className="text-white/80 text-xs font-semibold tracking-widest uppercase">Welcome Home</span>
            </div>
                  ...
                  <div ref={responseRef} className="flex flex-col h-full animate-fade-in overflow-y-auto custom-scrollbar max-h-[400px] pr-2">
                    ...
                    <div className="space-y-4 text-sm">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-gray-900 font-medium leading-relaxed">{response.wisdom}</p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 gap-3 pt-2">
                        <div className="bg-emerald-50 p-3 rounded-lg border border-emerald-100">
                          <div className="flex items-center gap-2 mb-1 text-emerald-700">
                            <Footprints size={12} />
                            <span className="text-[10px] font-bold uppercase">Faith In Action</span>
                          </div>
